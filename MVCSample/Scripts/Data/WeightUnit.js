...
var WeightUnitData = WeightUnitData || (function(){
	...
	return {
		...
		Delete: function(e) {
            ...
            $.ajax({
                url: '/api/WeightUnit/' + that.PublicId,
                type: 'DELETE',
                dataType: 'json',
                success: function(data) {

                    window.location.href = '/WeightUnit/';
		...
		Update: function(e) {
			...
			$.ajax({
				...
				success: function(data) {
					...
					window.location.href = '/WeightUnit/Edit/' + that.PublicId;
		...
		Create: function(e) {
			...
			$.ajax({
				...
				success: function(data) {
					...
					window.location.href = '/WeightUnit/Details/' + data;
